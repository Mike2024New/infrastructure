...
2. Сообщения в коммитах формируются автоматически, с помощью uuid4. Осмысленное описание изменений находится в .md
   файлах модулей (в них можно перейти в разделе # компоненты).